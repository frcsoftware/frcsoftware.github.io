...
const dictsToDownload = [ [resolve(ROOT, '.styles/config/dictionaries/en_US.dic'), 'https://raw.githubusercontent.com/LibreOffice/dictionaries/refs/tags/libreoffice-26.2.5.1/en/en_US.dic'], [resolve(ROOT, '.styles/config/dictionaries/en_US.aff'), 'https://raw.githubusercontent.com/LibreOffice/dictionaries/refs/tags/libreoffice-26.2.5.1/en/en_US.aff'] ];

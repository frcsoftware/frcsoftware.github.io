...
There are many other resources out there for FRC programming.
...
<CourseSection title="Documentation" href="/resources/docs">
    <p>
        There is a lot of documentation from FIRST Vendors, software libraries,
        logging software, and more. This page has links to helpful documentation
        that you might reference when programming.
    </p>
</CourseSection>

...
The main difference between beam breaks and limit switches is beam breaks use an emitter and reciever to identify game pieces while a limit switch is basically a touch sensor for mechanisms.

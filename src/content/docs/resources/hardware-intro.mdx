...
A beam brake detects if anything is between two points and returns a binary value.
...
The main difference between beam brakes and limit switches is beam brakes use an emitter and reciever to identify game pieces while a limit switch is basically a touch sensor for mechanisms.

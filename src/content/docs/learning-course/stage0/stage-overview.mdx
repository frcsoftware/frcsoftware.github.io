...
<ul>
    <li>
        {' '}
        <a href="\learning-course\stage0\intro-to-java\java-fundamentals/">
            {' '}
            Java Fundamentals{' '}
        </a>{' '}
    </li>
    <li>
        {' '}
        <a href="\learning-course\stage0\intro-to-java\operators/">
            {' '}
            Operators{' '}
        </a>{' '}
    </li>
    <li>
        {' '}
        <a href="\learning-course\stage0\intro-to-java\conditionals/">
            {' '}
            Conditionals{' '}
        </a>{' '}
    </li>

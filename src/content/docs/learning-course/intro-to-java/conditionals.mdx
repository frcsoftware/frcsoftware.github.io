...
next: false
defaultCodeRegionSource: stage0/snippets/Conditionals.java
---
...
Here's how this works: if the`if` statement's condition is `true`, then the the code inside will run.

...
Additionally, there are some rules for variable names.
For example, the name of the variable can not include spaces, instead you can write variables with camel case (frontLeftDrive).
...
What the print statement does is take information inside the parentheses, in the preceding example, it’s “hello!”, and prints it out to the terminal screen.

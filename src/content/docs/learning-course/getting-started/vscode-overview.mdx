...
Many options but the main ones are:

1. `New file`: New File creates a new file.
2. `Open file`: Open file lets you open a file from your computer.
3. `Open folder`: Open folder lets you open a folder from your computer.
...
<Aside type="caution">
    ...
    new projects on OneDrive are not supported.
</Aside>

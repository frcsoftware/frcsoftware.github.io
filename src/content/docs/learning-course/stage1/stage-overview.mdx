...
You'll end at stage 1C, which details how to log and read robot data with telemetry and perform basic robot control with PID.
...
- [Stage 1C](/learning-course/stage1/stage1c/stage-overview/)

...
1. A private `TalonFX` or `SparkMax` motor controller object, named `motor`, with CAN ID 5 on Systemcore CANBus 0.
...
<details class="accordion">
    <summary>Item 1, Hint 1 (CTRE only)</summary>
...
1. A private `TalonFX` or `SparkMax` motor controller object, named `motor`, with ID 4 on Systemcore bus 0.

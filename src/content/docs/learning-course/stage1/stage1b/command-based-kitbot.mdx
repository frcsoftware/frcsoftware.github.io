...
<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    <TabItem label="CTRE">
        ...
        on Systemcore bus 0.
        {/* prettier-ignore */}
        2. A `shoot()` command that waits 2 seconds, then sets the throttle of
        the motor to 0.9 forever.
        {/* prettier-ignore */}
        3. A `intake()` command that sets throttle to 0.8 forever.
        {/* prettier-ignore */}
        4. A `outtake()` command that sets throttle to -0.8 forever.
        {/* prettier-ignore */}
        5. A `idle()` command that sets throttle to 0 forever. Make this the
        default command.
        {/* prettier-ignore */}
        6. The code needed for simulating the intake launcher. You haven't

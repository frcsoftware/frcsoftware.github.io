...
<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    <TabItem label="CTRE">
        ...
        ```java stage1/stage1a/solutions/ctre/src/main/java/first/robot/opmode/MyAuto.java#SimpleAutoStart
        ```

    </TabItem>
    <TabItem label="REV">

        ```java stage1/stage1a/solutions/rev/src/main/java/first/robot/opmode/MyAuto.java#SimpleAutoStart
        ```
...
<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    <TabItem label="CTRE">
        ...
        ```java stage1/stage1a/solutions/ctre/src/main/java/first/robot/opmode/MyAuto.java#SimpleAutoEnd
        ```

    </TabItem>
    <TabItem label="REV">

        ```java stage1/stage1a/solutions/rev/src/main/java/first/robot/opmode/MyAuto.java#SimpleAutoEnd
        ```

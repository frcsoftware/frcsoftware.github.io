...
Given two motors on each side of the drivetrain, it's important to ensure that each of the motors on a side
moves in sync with the other.
...
<Aside type="note">
    Different classes should be used for different types of controllers. A
    generic `Gamepad` class can also be used to get button or axis values by
    index.
</Aside>

...
<Tabs>
    <TabItem label="CTRE">
        ...
        ```java stage1/stage1a/solutions/ctre/src/main/java/first/robot/opmode/MyTeleop.java#DrivetrainPeriodic
        ```

    </TabItem>
    <TabItem label="REV">

        ```java stage1/stage1a/solutions/rev/src/main/java/first/robot/opmode/MyTeleop.java#DrivetrainPeriodic
        ```

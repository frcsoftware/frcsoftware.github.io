...
```java stage1/snippets/src/main/java/sources/CommandBasedKitbotPt2.java#drivetrainDef
...
```java stage1/snippets/src/main/java/sources/CommandBasedKitbotPt2.java#opModeSkeleton

...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#runAtThrottleDouble

```

And the following code in Robot.java:

```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#incorrectCommand
...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#runAtThrottleSupplier
...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#doubleSupplierExample
...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#correctCommand
...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#triggerBooleanSupplier
...
```java stage1/snippets-1b/src/main/java/sources/SuppliersInCommandBased.java#untilModifier

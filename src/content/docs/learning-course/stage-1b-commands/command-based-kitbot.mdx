...
<details class="accordion">
    ...
    ```java stage1/snippets/src/main/java/sources/CommandBasedKitbot.java#feederDef
...
```java stage1/snippets/src/main/java/sources/CommandBasedKitbot.java#feederSim

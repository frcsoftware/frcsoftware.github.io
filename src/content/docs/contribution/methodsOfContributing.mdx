...
FRCSoftware.org is just getting started, so the easiest way to propose work is by [opening a GitHub issue](https://github.com/frcsoftware/frcsoftware.org/issues) in the main repository.

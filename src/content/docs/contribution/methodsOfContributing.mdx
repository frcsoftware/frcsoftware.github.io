...
[FRCSoftware.org](https://github.com/frcsoftware/frcsoftware.org) is just getting started, so the easiest way to propose work is by opening a GitHub issue in the main repository.

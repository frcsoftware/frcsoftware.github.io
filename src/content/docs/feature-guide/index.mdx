...
![Slide 2](img/slide2.webp) The dots below the caption indicate the slide you're on. They can also be clicked to navigate to slides.

![Slide 3](https://www.youtube.com/watch?v=sgEnAByelWs) Some slideshows contain videos. Click any slide to open a larger lightbox view.

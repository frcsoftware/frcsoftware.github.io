...
```java stg0/JavaFundamentals.java#variables
...
```java stg0/JavaFundamentals.java#printLiteral
...
```java stg0/JavaFundamentals.java#printVariable
...
```java stg0/JavaFundamentals.java#singleLineComment

```

You will also see comments placed at the end of a line like the following

```java stg0/JavaFundamentals.java#inlineComment
...
```java stg0/JavaFundamentals.java#multiLineComment

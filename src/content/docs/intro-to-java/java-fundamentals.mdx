...
```java file=stg0/JavaFundamentals.java region=variables
...
```java file=stg0/JavaFundamentals.java region=printLiteral
...
```java file=stg0/JavaFundamentals.java region=printVariable
...
```java file=stg0/JavaFundamentals.java region=singleLineComment

```

You will also see comments placed at the end of a line like the following

```java file=stg0/JavaFundamentals.java region=inlineComment
...
```java file=stg0/JavaFundamentals.java region=multiLineComment
